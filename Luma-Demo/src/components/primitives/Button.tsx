...
export function Button({ children, onClick, type = 'button', size = 'md', variant = 'primary', disabled, className }: ButtonProps) {
    ...
    const variants: Record<string, string> = {
        ...
        ghost: 'bg-transparent text-text-secondary border border-border-subtle hover:text-text-primary hover:border-border-default',
        outline: 'bg-transparent text-text-secondary border border-border-subtle hover:text-text-primary',
    };
    return (
